...
export default function project(){
    return (
        ...
        <section className="p-4 h-full">
            ...
            <Cards title='BharatGiG' imgSrc='/bharatGIG.png' desc='This Project contains the projects and tasks I completed during my internship at #BharatGiG. The internship focused on enhancing my skills in web development' URL='#'/>
